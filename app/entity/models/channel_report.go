...
type ChannelReport struct {
	...
	Date            time.Time      `gorm:"column:date" json:"date" form:"date" comment:"统计日期"`                                            //统计日期
	...
	UvClicks        *int           `gorm:"column:uv_clicks" json:"uv_clicks" form:"uv_clicks" comment:"UV 点击量（仅适用于 H5 平台）"`               //UV 点击量（仅适用于 H5 平台）
	Activation      *int           `gorm:"column:activation" json:"activation" form:"activation" comment:"激活数量"`                          //激活数量
